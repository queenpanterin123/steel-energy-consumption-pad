...
Wykres balansu klas ukazuje niezbilansowanie zbioru - klasa "Light_Load" zdecydowanie dominuje, poczas gdy krytyczna biznesowo klasa "Maximum_Load" jest najmniej liczna. Jakie kroki w związku z tym podjęłyśmy: 
...
ggplot(wykres_dane, aes(x = reorder(model, .estimate, FUN = max), y = .estimate, fill = model)) +
  ...
  labs(
    ...
    subtitle = "Zestawienie Dokładności oraz współczynnika Kappa",
    y = "Wynik Metryki"
  )
```
